...
app.get("/api/admin/users", authenticateAdmin, async (req, res) => {
  ...
  try {
    ...
    //Check if we can query anything from users table
...
app.get("/api/admin/reports", authenticateAdmin, async (req, res) => {
  try {
    ...
    switch (type) {
      ...
      case 'users':
      //User distribution report with role normalization
      reportData = await pool.query(`
        SELECT 
          CASE 
            WHEN LOWER(role) = 'patient' THEN 'Patient'
...
app.delete("/api/admin/users/:userId", authenticateAdmin, async (req, res) => {
  ...
  try {
    ...
    // Handle prescriptions - set patient_id to null 
...
app.put("/api/admin/users/:userId", authenticateAdmin, async (req, res) => {
  ...
  try {
    ...
    // get current user role to know which table to update
