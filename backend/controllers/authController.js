...
const signup = async (req, res) => {
  ...
  try {
    ...
    switch (role) {
      case "Patient":
        await client.query(
          `INSERT INTO patients (user_id, primary_doctor_id)
           VALUES ($1, $2)`,
      ...
      case "Doctor":
        await client.query(
          `INSERT INTO doctors (user_id, specialty, medical_license)
           VALUES ($1, $2, $3)`,
      ...
      case "Pharmacist":
        await client.query(
          `INSERT INTO pharmacists (user_id, pharmacy_name, pharmacy_license)
           VALUES ($1, $2, $3)`,
      ...
      case "Supplier":
        await client.query(
          `INSERT INTO suppliers (user_id, company_name, supplier_reg_id)
           VALUES ($1, $2, $3)`,
...
const login = async (req, res) => {
  ...
  try {
    ...
    if (user.role === 'Patient') {
      ...
      roleData = supplierResult.rows[0];
    }
