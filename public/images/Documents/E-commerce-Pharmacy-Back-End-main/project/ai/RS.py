...
# load model
svc = pickle.load(open("ai/svc.pkl", 'rb'))

# Recommendation System & Prediction
sym_des = pd.read_csv('ai/Datasets/symtoms_df.csv')
precautions = pd.read_csv('ai/Datasets/precautions_df.csv')
workout = pd.read_csv('ai/Datasets/workout_df.csv')
description = pd.read_csv('ai/Datasets/description.csv')
medications = pd.read_csv('ai/Datasets/medications.csv')
# medications=None
# diets=None
diets = pd.read_csv('ai/Datasets/diets.csv')
